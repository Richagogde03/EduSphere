...
const Contact = () => {
  //used Web3Froms for api key and this code(backend)
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "b40fb5d1-3f5c-4d37-adae-adb5fca476a8");
    ...
    <div className='contact' id='contact'>
        <div className="contact-col">
            ...
            <ul>
                ...
                <li><img src={phone_icon} alt="" /> +1 731-689-7000 </li>
                <li><img src={location_icon} alt="" /> 17, Yemen Road, Yemen</li>
            </ul>
        </div>
        <div className="contact-col">
